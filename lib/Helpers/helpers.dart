...
class AppColors {
  ...
  static const iconColorButton = Color.fromARGB(255, 17, 17, 17);
  static const disableButtonColor = Color.fromARGB(255, 206, 206, 204);
  static const filledColor = Color.fromARGB(255, 239, 239, 238);
  ...
  static const themeColor = Color.fromARGB(255, 38, 121, 33);
  static const colorMenu = Color.fromARGB(255, 229, 249, 219);
...
/// warna untuk home version 2
  ...
  static const datecolor = Color.fromARGB(255, 51, 51, 51);
  static const buttonColor = Color.fromARGB(255, 38, 121, 33);
  static const color1 = Color.fromARGB(255, 213, 240, 133);
  static const color2 = Color.fromARGB(255, 148, 201, 71);
  static const color3 = Color.fromARGB(255, 70, 122, 58);
  static const color4 = Color.fromARGB(255, 38, 121, 33);
...
onMapTap(LatLng poinTap)async {
  ...
  // myMarker.clear();
  // cek += 1;
  // MapHelper.isWithinRadius(latitude: poinTap.latitude,longitude: poinTap.longitude).then((isWithinRadius) {
  //   if(isWithinRadius){
  ...
  //   }else{
  //     Get.defaultDialog(
  //       title: "Anda Diluar Jangkauan Radius",
  //     );
  //   }
  // });
  myMarker = [];
...
class MapHelper {
  static Set<Circle> addCircle() {
    return {
      Circle(
        circleId: CircleId("1"),
        center: LatLng(5.5466, 95.3191),
        radius: 1000,
  ...
  static Future<bool> isWithinRadius({double latitude = 0.0, double longitude = 0.0}) async {
    ...
    if (permission == LocationPermission.denied) {
      permission = await Geolocator.requestPermission();
      if (permission == LocationPermission.denied) {
        // Handle kasus jika pengguna menolak memberikan izin lokasi
        return false;
      }
    }
